...
export const EFFECT_ICON_PLACEHOLDERS: Record<IconId, IconPlaceholderSpec> = {
  ...
  light: { letter: "*", color: "#ffe2a0" },
  heat: { letter: "T", color: "#ffb04f" },
  freeze: { letter: "F", color: "#bfe9ff" },
  thaw: { letter: "M", color: "#ffd17a" },
