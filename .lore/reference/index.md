...
- [RunModifiers — the Engine Hooks Unlocks Actually Touch](run-modifiers-engine-hooks.md) - one assembled modifier bag feeds starting stats, hand growth, resource floors, reward rarity, keyword progress, act boons, and effective player cards without exposing the unlock catalog to core.
